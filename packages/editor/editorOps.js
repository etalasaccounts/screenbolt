...
import { fixWebmDurationOffThread } from "./mediabunny/utils/fixWebmDurationOffThread";

const lazyUtil = (importFn) =>
 (...args) =>
  importFn().then((m) => m.default(...args));
const addAudioToVideo = lazyUtil(() => import("./mediabunny/utils/addAudioToVideo"));
const convertWebmToMp4 = lazyUtil(() => import("./mediabunny/utils/convertWebmToMp4"));
const cropVideo = lazyUtil(() => import("./mediabunny/utils/cropVideo"));
const cutVideo = lazyUtil(() => import("./mediabunny/utils/cutVideo"));
const muteVideo = lazyUtil(() => import("./mediabunny/utils/muteVideo"));
const reencodeVideo = lazyUtil(() => import("./mediabunny/utils/reencodeVideo"));
const toGIF = lazyUtil(() => import("./mediabunny/utils/toGIF"));
const getFrame = lazyUtil(() => import("./mediabunny/utils/getFrame"));
const convertMp4ToWebm = lazyUtil(() => import("./mediabunny/utils/convertMp4ToWebm"));
...
export async function runEditorOp(message, reply, { viewer = false } = {}) {
 ...
 try {
  ...
  console.error("[Screenbolt][Editor] op failed", {
   type: message.type,
   message: errMsg,
   stack: errStack,
   opId: message._opId,
