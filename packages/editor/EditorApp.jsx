...
.screenbolt-scrollbar *::-webkit-scrollbar, .screenbolt-scrollbar::-webkit-scrollbar {
  background-color: rgba(0,0,0,0);
  width: 16px;
  height: 16px;
  z-index: 999999;
}
.screenbolt-scrollbar *::-webkit-scrollbar-track, .screenbolt-scrollbar::-webkit-scrollbar-track {
  background-color: rgba(0,0,0,0);
}
.screenbolt-scrollbar *::-webkit-scrollbar-thumb, .screenbolt-scrollbar::-webkit-scrollbar-thumb {
  background-color: rgba(0,0,0,0);
  border-radius:16px;
  border:0px solid #fff;
}
.screenbolt-scrollbar *::-webkit-scrollbar-button, .screenbolt-scrollbar::-webkit-scrollbar-button {
  display:none;
}
.screenbolt-scrollbar *:hover::-webkit-scrollbar-thumb, .screenbolt-scrollbar:hover::-webkit-scrollbar-thumb {
