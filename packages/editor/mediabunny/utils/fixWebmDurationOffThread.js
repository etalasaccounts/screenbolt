...
// "?raw" (not webpack's inline "!!raw-loader!..." syntax, which Turbopack
// doesn't recognize) so this loads identically under both apps/extension's
// webpack config (a resourceQuery rule, see webpack.config.js) and apps/web's
// Turbopack config (a matching turbopack.rules entry, see next.config.ts).
import webmDurationLibSrc from "fix-webm-duration/fix-webm-duration.js?raw";
