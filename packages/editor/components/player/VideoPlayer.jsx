    ...
    if (contentState.webm || contentState.blob) {
      ...
      setSource({
        ...
        sources: [
          {
            src: objectURL,
            // `vid.type` reflects the real bytes -- unlike the old
            // `contentState.blob ? "video/mp4" : "video/webm"`, which
            // mislabeled apps/web's fast-path raw webm blob (stored in
            // `contentState.blob`, same as a real mp4 would be) as mp4,
            // causing the browser to refuse to play it. See the matching
            // fix in components/editor/VideoPlayer.jsx for the full story.
            type: vid.type || (contentState.blob ? "video/mp4" : "video/webm"),
          },
        ],
      });
      setUrl(objectURL);
    ...
    <div className="videoPlayer">
      <div className="playerWrap">
        ...
        {(contentState.playerLoading || contentState.finalizingRecording) &&
          ...
          createPortal(
            <div
              className="screenbolt-player-loading"
              style={{
                position: "absolute",
                inset: 0,
            ...
            >
              <div
                style={{
                  ...
                  borderTopColor: "#fff",
                  borderRadius: "50%",
                  animation: "screenbolt-spin 0.9s linear infinite",
                }}
              />
