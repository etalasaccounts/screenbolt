...
const BlurTool = () => {
  ...
  useLayoutEffect(() => {
    ...
    const handleMouseMove = (event) => {
      ...
      if (
        !target.classList.contains("screenbolt-outline") &&
        !target.closest("#screenbolt-ui #screenbolt-ui *")
      ) {
    ...
    const handleMouseDown = (event) => {
      ...
      const target = event.target;
      if (target.closest("#screenbolt-ui, #screenbolt-ui *")) {
        return;
      }
    ...
    const handleElementClick = (event) => {
      ...
      event.preventDefault();
      event.stopPropagation();
      target.classList.toggle("screenbolt-blur");
    };
