...
const POPOVER_CLASS = "ScreenboltOnboardingPopover onboarding-popover";
const DRIVER_STYLE_ID = "screenbolt-driver-onboarding-style";
const TOOLBAR_HELP_URL =
 "https://help.screenbolt.app/recording/how-to-hide-the-toolbar";
...
const DEBUG =
 typeof window !== "undefined" && Boolean(window.SCREENBOLT_DEBUG_ONBOARDING);
...
const logDebug = (event, payload = {}) => {
 ...
 console.debug("[Screenbolt][Onboarding]", event, payload);
};
...
const getOnboardingText = () => ({
 welcomeTitle: t(
  ...
  "Welcome to the Screenbolt Pro extension",
 ),
...
const clearDriverUiState = (root) => {
 document.documentElement.classList.remove("screenbolt-driver-modal-step");
 document.documentElement.classList.remove("screenbolt-driver-active");
...
const ensureDriverStyles = () => {
 ...
 style.textContent = `
  ...
  .driver-popover.ScreenboltOnboardingPopover,
  .ScreenboltOnboardingPopover {
  ...
  .driver-popover.ScreenboltOnboardingPopover .driver-popover-title,
  .ScreenboltOnboardingPopover .driver-popover-title {
  ...
  .driver-popover.ScreenboltOnboardingPopover .driver-popover-description,
  .ScreenboltOnboardingPopover .driver-popover-description {
   font-size: 14px !important;
   font-family: "Satoshi-Medium", sans-serif !important;
   font-weight: 500 !important;
  ...
  .driver-popover.ScreenboltOnboardingPopover .driver-popover-close-btn,
  .ScreenboltOnboardingPopover .driver-popover-close-btn {
   display: none !important;
  }
  .driver-popover.ScreenboltOnboardingPopover .driver-popover-description a,
  .ScreenboltOnboardingPopover .driver-popover-description a {
   color: #3b82f6 !important;
   text-decoration: none !important;
   cursor: pointer !important;
  }
  .driver-popover.ScreenboltOnboardingPopover .driver-popover-progress-text,
  .ScreenboltOnboardingPopover .driver-popover-progress-text {
   font-size: 12px !important;
   font-family: "Satoshi-Medium", sans-serif !important;
   color: var(--color-text-secondary, #667085) !important;
   opacity: 0.7 !important;
  }
  .driver-popover.ScreenboltOnboardingPopover .driver-popover-footer .driver-popover-navigation-btns,
  .ScreenboltOnboardingPopover .driver-popover-footer .driver-popover-navigation-btns {
   gap: 6px !important;
  }
  .driver-popover.ScreenboltOnboardingPopover .driver-popover-footer .driver-popover-navigation-btns .driver-popover-next-btn,
  .driver-popover.ScreenboltOnboardingPopover .driver-popover-footer .driver-popover-navigation-btns .driver-popover-prev-btn,
  .ScreenboltOnboardingPopover .driver-popover-footer .driver-popover-navigation-btns .driver-popover-next-btn,
  .ScreenboltOnboardingPopover .driver-popover-footer .driver-popover-navigation-btns .driver-popover-prev-btn {
   border-radius: 30px !important;
...
.screenbolt-driver-modal-step .driver-stage,
.screenbolt-driver-modal-step .driver-stage-wrapper {
 display: none !important;
}

.screenbolt-driver-modal-step .driver-popover-arrow {
 display: none !important;
}

.screenbolt-driver-modal-step .driver-popover.ScreenboltOnboardingPopover,
.screenbolt-driver-modal-step .ScreenboltOnboardingPopover {
...
.screenbolt-driver-modal-step .ScreenboltOnboardingPopover {
 ...
 padding: 26px !important;
	...
	/* Welcome icon */
.screenbolt-driver-modal-step .screenbolt-welcome-emoji {
 font-size: 24px;
 line-height: 1;
 margin-bottom: 10px;
}
...
const lowerRootContainerZIndex = (root) => {
 const container =
  find(root, "#screenbolt-root-container") ||
  root?.host ||
  document.getElementById("screenbolt-root-container");
 if (!container) return () => {};
...
const startDriver = ({ steps, root, getState, onFinish, copy }) => {
 ...
 document.documentElement.classList.add("screenbolt-driver-active");
   ...
   if (step.id === STEP_IDS.WELCOME && popover?.title) {
    ...
    if (
     !popover.title.parentElement?.querySelector(
      ".screenbolt-welcome-emoji",
     )
    ) {
     const emoji = document.createElement("div");
     emoji.className = "screenbolt-welcome-emoji";
     emoji.textContent = "👋";
