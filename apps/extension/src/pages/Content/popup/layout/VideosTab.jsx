...
const VideosTab = (props) => {
  ...
  const handleVideoClick = (videoId) => {
    ...
    const url = process.env.SCREENBOLT_APP_BASE + `/editor/${videoId}/edit`;
  ...
  const handleCopyLink = (videoId) => {
    ...
    const link = process.env.SCREENBOLT_APP_BASE + `/view/${videoId}`;
    navigator.clipboard
      .writeText(link)
      .then(() => {
      ...
      <Tabs.Root className="TabsRoot" defaultValue="personal">
        ...
        <Tabs.Content className="TabsContent" value="personal">
          ...
          <div className="bottom-section">
            <a
              href={process.env.SCREENBOLT_APP_BASE}
              target="_blank"
