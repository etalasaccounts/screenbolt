...
// TODO(screenbolt): replace this (and the matching oauth2.client_id in
// src/manifest.json) with Screenbolt's own Google OAuth client before any
// store release. These are inherited from the original extension's Google project.
