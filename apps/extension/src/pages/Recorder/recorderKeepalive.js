...
// throttle on region recordings. Handles hang off window.__SCREENBOLT_KEEPALIVE.
(function () {
 try {
  var KA = (window.__SCREENBOLT_KEEPALIVE =
   window.__SCREENBOLT_KEEPALIVE || {});
  KA.startedAt = Date.now();
  try {
   performance.mark("screenbolt-keepalive-start");
  } catch (e) {}
  ...
  try {
   performance.mark("screenbolt-keepalive-end");
  } catch (e) {}
 } catch (e) {}
})();
