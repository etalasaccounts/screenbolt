CREATE TYPE "public"."source" AS ENUM('local', 'blob', 'drive', 'dropbox');--> statement-breakpoint
...
CREATE TABLE "users" (
	...
	"dropbox_token_expiry" timestamp with time zone,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE "videos" (
	...
	"source" "source" DEFAULT 'blob' NOT NULL,
	"user_id" text NOT NULL,
