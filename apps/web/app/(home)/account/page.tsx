...
export default function AccountPage() {
  ...
  const { data: deviceTokens = [], isLoading: devicesLoading } = useDeviceTokens();
  const { data: cloudConfig, isLoading: cloudLoading } = useCloudConnections();
    ...
    <div className="mx-auto max-w-3xl">
      ...
      <section className="mb-6 rounded-3xl border border-black/[.08] bg-white p-6 sm:p-7">
        ...
        {devicesLoading ? (
          ...
          <DeviceList devices={deviceTokens} />
        )}
      </section>
