    ...
    <div className="mx-auto max-w-3xl">
      ...
      <section className="mb-6 space-y-4 rounded-3xl border border-black/[.08] bg-white p-6 sm:p-7">
        <div className="flex items-center gap-4">
          <div className="h-14 w-14 shrink-0 animate-pulse rounded-full bg-black/[.08]" />
          <div className="flex-1">
            <div className="mb-2 h-6 w-32 animate-pulse rounded bg-black/[.08]" />
            <div className="h-4 w-24 animate-pulse rounded bg-black/[.08]" />
          </div>
        </div>
      ...
      <section className="mb-6 space-y-4 rounded-3xl border border-black/[.08] bg-white p-6 sm:p-7">
        <div className="h-6 w-40 animate-pulse rounded bg-black/[.08]" />
        <div className="space-y-2">
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="h-12 animate-pulse rounded-lg bg-black/[.08]" />
          ))}
        </div>
      </section>
